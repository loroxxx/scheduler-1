...
public class ProductVo {
     ...
     * 产品当日申购金额上限
     */
    private BigDecimal productSubToplimit;
    ...
    /**
     * 01-认购期(导入产品要素后，在产品成立日清算前);02-存续期(产品成立日后，产品到期日清算前);03-产品终止
     */
     ...
     * 获取申购起始金额
     *
     * @return subs_start_amount - 申购起始金额
     */
    ...
    /**
     * 获取01-认购期(导入产品要素后，在产品成立日清算前);02-存续期(产品成立日后，产品到期日清算前);03-产品终止
     *
     * @return product_state - 01-认购期(导入产品要素后，在产品成立日清算前);02-存续期(产品成立日后，产品到期日清算前);03-产品终止
     */
    ...
    /**
     * 设置01-认购期(导入产品要素后，在产品成立日清算前);02-存续期(产品成立日后，产品到期日清算前);03-产品终止
     *
     * @param productState 01-认购期(导入产品要素后，在产品成立日清算前);02-存续期(产品成立日后，产品到期日清算前);03-产品终止
     */
    ...
    public BigDecimal getProductSubToplimit() {
        return productSubToplimit;
    }

    public void setProductSubToplimit(BigDecimal productSubToplimit) {
        this.productSubToplimit = productSubToplimit;
    }
